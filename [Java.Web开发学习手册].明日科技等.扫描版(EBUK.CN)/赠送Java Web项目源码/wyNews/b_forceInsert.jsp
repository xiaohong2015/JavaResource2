...
<html:form action="forceAction.do?method=insertForceAction" onsubmit="return checkEmpty(forceForm)">
	<table width="640" border="1" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#E8E6E7">
      <tr>
        ...
        <td width="537" bgcolor="#FFFFFF"><html:text property="title" title="请输入焦点导读题目" size="90"/></td>
      </tr>
      <tr>
        <td height="178"><div align="center">焦点内容：</div></td>
        <td bgcolor="#FFFFFF" valign="top"><html:textarea property="content" title="请输入焦点的主要内容" cols="90" rows="20"/></td>
      </tr>
      <tr>
    ...
    <tr><td  align="right"><html:submit>添加
</html:submit>&nbsp;&nbsp;&nbsp;
<html:reset>清除
</html:reset>&nbsp;&nbsp;&nbsp;
