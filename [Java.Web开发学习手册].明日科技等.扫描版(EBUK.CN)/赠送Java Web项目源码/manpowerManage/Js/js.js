...
function userValidate_up(){
	...
	if(userForm.isadmin.value=="1"){
		if(userForm.password_old.value!=userForm.hpassword_old.value){
			alert("您输入的原密码不正确，请重新输入！");
			userForm.password_old.value="";
			userForm.password_old.focus();
			return false;			
		}
		if(userForm.password.value==""){
			alert("请填写新密码！");		
		...
		if(userForm.password_new.value==""){
			alert("请确认新密码！");		
			userForm.password_new.focus();
			return false;
		}
		if(userForm.password.value!=userForm.password_new.value){
			alert("您两次输入的新密码不一致，请重新输入！");
			userForm.password.value="";
			userForm.password_new.value="";
			userForm.password.focus();
			return false;
		}
	}
