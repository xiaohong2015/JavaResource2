		...
		<table width="965" border="0" cellpadding="0" cellspacing="0">
				...
				<tr bgcolor="#EDEEFF">
					...
					<td width="720" align="center" valign="top" bgcolor="#E8F1F6">
      					<table width="60%" border="5" cellspacing="0" cellpadding="5" bordercolor="#F0F0F0" bordercolorlight="#1687AF" bordercolordark="#E8F1F6" rules="none" bgcolor="white" style="margin-top:80">
         					<tr height="20"><td bgcolor="#B9D9E9"><b>友情提示!</b></td></tr>
         					<tr height="120"><td align=center>请选择资产管理类别!</td></tr>
      					</table>
					</td>
