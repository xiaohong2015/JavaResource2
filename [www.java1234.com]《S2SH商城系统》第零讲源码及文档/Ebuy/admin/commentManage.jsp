...
<div id="dlg" class="easyui-dialog" style="width: 650px;height: 450px;padding: 10px 20px"
  ...
  <form id="fm" method="post">
  	<table cellspacing="8px;">
  		<tr>
  			...
  			<td colspan="4">
  				<textarea id="content" name="comment.content"  rows="7" cols="50"  readonly="readonly"></textarea>
  			</td>
  		</tr>
  		<tr>
  			<td valign="top">回复内容：</td>
  			<td colspan="4">
  				<textarea id="replyContent" name="comment.replyContent" rows="7" cols="50"  ></textarea>
