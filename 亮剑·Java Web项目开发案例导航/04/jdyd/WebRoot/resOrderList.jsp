  ...
  <body>
  	<div class="MainBox">
	  	...
	  	<span style="margin-left:5px;margin-bottom:0px;">
	  		<h:outputText value="首页 >> #{RLBean.rname}资源状态"></h:outputText>
	  	</span>
	  	<div style="text-align:center;">
	  	<h:outputText value="该资源目前没有订单，可以预订" rendered="#{RLBean.size<=0&&RLBean.isOrder}"/>
	  	<h:outputText value="该资源有未处理好的订单，不可预订" rendered="#{!RLBean.isOrder}"/>
