...
public class MySaleInfoBean {
	...
	public void setMmsib(ModifyMySaleInfoBean mmsib) {
		this.mmsib = mmsib;
	}
	...
	public String getInitList() {
		String type = "";
		try {
			type = new String("³öÊÛ".getBytes(),"ISO-8859-1");
		}
		catch(Exception e) {
			e.printStackTrace();
		}
	...
	public String modifySaleObj() {
		this.mmsib.setSi((SaleInfo)dm.getRowData());
		return "modifymysaleinfo";
	}
}