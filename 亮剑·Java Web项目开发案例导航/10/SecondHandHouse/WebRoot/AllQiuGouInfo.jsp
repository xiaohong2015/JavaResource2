					...
					<div style="width:567px;margin:5px 0;">
						...
						<div class="outer" style="margin:0 0;padding:0;height:400px;">
						    ...
						    <h:panelGrid columns="4" style="width:100%;">
						    	<h:panelGroup>
						    		<h:outputText value="当前页：第#{AllQiuGouInfoBean.nowPage}页"/>&nbsp;&nbsp;
						    		<h:outputText value="共#{AllQiuGouInfoBean.totalPage}页"/>
								</h:panelGroup>
								<h:form>
							...
							<h:outputText value=" 没有您要查看的信息！" rendered="#{!AllQiuGouInfoBean.showList}"/>
						</div>
					</div>
				</div>
