		...
		<body>
			<div id="wrapper">
				...
				<h:panelGrid columns="2" style="border:1px solid gray;width:80%;">
					...
					<h:panelGroup>
						<h:outputText value="经度："/>
						<h:outputText value="#{MyRentDetailBean.longitude}"/>
					</h:panelGroup>
					<h:panelGroup>
						<h:outputText value="纬度："/>
						<h:outputText value="#{MyRentDetailBean.latitude}"/>
					</h:panelGroup>
					<h:panelGroup>
