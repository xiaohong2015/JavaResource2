		...
		<body onload="JavaScript:login();">
			<div id="wrapper">
				...
				<div style="border:1px solid gray;width:85%;margin:20px;padding-bottom:20px;">
					<div style="background-color:#F7AE31;">出租信息修改</div><br/>
					<h:form id="mf_rent" onsubmit="JavaScript:return check();">
						<h:inputText value="#{ModifyMyRentInfoBean.msgtype}" id="msgtype" style="display:none;"/>
						<h:panelGrid columns="2" style="font-size:14px;">
				   			<h:outputText value="房源坐落位置：" style="text-align:right;width:100%;"/>
				   			<h:panelGroup>
				   				<h:inputText value="#{ModifyMyRentInfoBean.location}" id="location" required="true" />
				   			...
				   			<h:panelGroup>
				   				<h:inputText id="detail" value="#{ModifyMyRentInfoBean.detail}" required="true"/>
				   			...
				   			<h:panelGroup>
				   				<h:inputText value="#{ModifyMyRentInfoBean.longitude}" id="longitude" required="true"/>
				   			...
				   			<h:panelGroup>
				   				<h:inputText value="#{ModifyMyRentInfoBean.latitude}" id="latitude" required="true"/>
